...
const iconNames = [
  ...
  'search', 'upload', 'download', 'file-export', 'file-import', 'filter', 'share', 'share-ios', 'pencil', 'copy', 'trash', 'backspace', 'remove', 'cog', 'wrench', 'cinfigurations', 'lock', 'lock-off', 'unlock', 'mail', 'eye', 'eye-off', 'dots', 'dots-vertical', 'menu',
  'home', 'monitor', 'phone', 'calendar', 'calendar-plus', 'note', 'code', 'curly-braces', 'megaphone', 'heart-handshake', 'offer', 'featured-offer', 'ranking', 'brush', 'design-tools', 'chart-pie', 'table', 'table-pencil', 'webpage', 'web-ad', 'store', 'test-tube', 'click', 'bell', 'coffee', 'map', 'circle-square', 'gift', 'package', 'package-search', 'login', 'logout',
