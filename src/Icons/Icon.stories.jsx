...
const iconNames = [
  ...
  'home', 'monitor', 'phone', 'calendar', 'calendar-plus', 'note', 'code', 'curly-braces', 'megaphone', 'offer', 'featured-offer', 'brush', 'design-tools', 'chart-pie', 'table', 'table-pencil', 'webpage', 'web-ad', 'store', 'test-tube', 'click', 'bell', 'coffee', 'map', 'circle-square', 'table-pencil', 'gift', 'ranking',
