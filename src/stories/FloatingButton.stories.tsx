...
export const FilledLarge = () => (
  <FloatingButton icon="dots-vertical" ariaLabel="Add large" variant="filled" sizeVariant="large" style={{ position: 'relative', bottom: 0, right: 0 }} />
);
